...
local window = library:AddWindow("DESTROYER | Private Killing", {
...
switch:Set(false)
killingTab:AddSwitch("Block Eating Eggs", function(state)
if state then
    local Players = game:GetService("Players")
local player  = Players.LocalPlayer
...
local function equipOnRespawn(petList)
    ...
    for i = 1, math.min(8, #petList) do
        pcall(function() equipEvent:FireServer("equipPet", petList[i]) end)
    end
end
...
local playerStatsLabel = specsTab:AddLabel("Player Stats:")
...
specsTab:AddLabel("————————————————————————————————————————")
local advancedStatsLabel = specsTab:AddLabel("Advanced Stats:")
advancedStatsLabel.TextSize = 35
...
enemyHealthLabel.TextColor3 = Color3.fromRGB(255, 0, 0)
...
playerDamageLabel.TextColor3 = Color3.fromRGB(0, 255, 0)
...
hitsToKillLabel.TextColor3 = Color3.fromRGB(0, 0, 255)
